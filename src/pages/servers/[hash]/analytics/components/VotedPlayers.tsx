...
interface VotedPlayersProps {
  players: ServersType.PlayerObject[]
}

const VotedPlayersContainer = styled('div', {
  padding: '$6',
...
export const VotedPlayers = ({ players }: VotedPlayersProps): JSX.Element => {
  ...
  return (
    <VotedPlayersContainer>
      <TitleContainer>
        <Heading as={'h5'} weight={'bold'}>
          Jogadores que mais votaram
        </Heading>
