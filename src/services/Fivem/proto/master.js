/* eslint-disable block-scoped-var, id-length, no-control-regex, no-magic-numbers, no-prototype-builtins, no-redeclare, no-shadow, no-var, sort-vars, @typescript-eslint/no-var-requires */
'use strict'
...
$root.master = (function () {
  ...
  master.Player = (function () {
    ...
    Player.fromObject = function fromObject(object) {
      if (object instanceof $root.master.Player) return object
      var message = new $root.master.Player()
  ...
  master.ServerData = (function () {
    ...
    ServerData.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create()
      if (
        message.svMaxclients != null &&
        Object.hasOwnProperty.call(message, 'svMaxclients')
      )
        writer.uint32(/* id 1, wireType 0 = */ 8).int32(message.svMaxclients)
      if (
        message.clients != null &&
        Object.hasOwnProperty.call(message, 'clients')
      )
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, 'gametype')
      )
        writer.uint32(/* id 5, wireType 2 = */ 42).string(message.gametype)
      if (
        message.mapname != null &&
        Object.hasOwnProperty.call(message, 'mapname')
      )
      ...
      if (message.players != null && message.players.length)
        for (var i = 0; i < message.players.length; ++i)
          $root.master.Player.encode(
            message.players[i],
            writer.uint32(/* id 10, wireType 2 = */ 82).fork(),
          ).ldelim()
      if (
        message.iconVersion != null &&
        Object.hasOwnProperty.call(message, 'iconVersion')
      )
      ...
      if (message.vars != null && Object.hasOwnProperty.call(message, 'vars'))
        for (var keys = Object.keys(message.vars), i = 0; i < keys.length; ++i)
          writer
            ...
            .string(keys[i])
            .uint32(/* id 2, wireType 2 = */ 18)
            .string(message.vars[keys[i]])
            .ldelim()
      if (
        message.enhancedHostSupport != null &&
        Object.hasOwnProperty.call(message, 'enhancedHostSupport')
      )
        writer
          .uint32(/* id 16, wireType 0 = */ 128)
          .bool(message.enhancedHostSupport)
      if (
        message.upvotePower != null &&
        Object.hasOwnProperty.call(message, 'upvotePower')
      )
      ...
      if (message.connectEndPoints != null && message.connectEndPoints.length)
        for (var i = 0; i < message.connectEndPoints.length; ++i)
          writer
            ...
            .string(message.connectEndPoints[i])
      if (
        message.burstPower != null &&
        Object.hasOwnProperty.call(message, 'burstPower')
      )
        ...
        switch (tag >>> 3) {
          ...
          case 10:
            ...
            message.players.push(
              $root.master.Player.decode(reader, reader.uint32()),
            )
            break
          case 11:
            ...
            break
          case 12:
            if (message.vars === $util.emptyObject) message.vars = {}
    ...
    ServerData.verify = function verify(message) {
      ...
      if (
        message.svMaxclients != null &&
        message.hasOwnProperty('svMaxclients')
      )
      ...
      if (message.mapname != null && message.hasOwnProperty('mapname'))
        if (!$util.isString(message.mapname)) return 'mapname: string expected'
      ...
      if (message.server != null && message.hasOwnProperty('server'))
        if (!$util.isString(message.server)) return 'server: string expected'
      ...
      if (message.vars != null && message.hasOwnProperty('vars')) {
        if (!$util.isObject(message.vars)) return 'vars: object expected'
      ...
      if (
        message.enhancedHostSupport != null &&
        message.hasOwnProperty('enhancedHostSupport')
      )
      ...
      if (
        message.connectEndPoints != null &&
        message.hasOwnProperty('connectEndPoints')
      ) {
    ...
    ServerData.fromObject = function fromObject(object) {
      if (object instanceof $root.master.ServerData) return object
      var message = new $root.master.ServerData()
      if (object.svMaxclients != null)
        message.svMaxclients = object.svMaxclients | 0
      if (object.clients != null) message.clients = object.clients | 0
      if (object.protocol != null) message.protocol = object.protocol | 0
      if (object.hostname != null) message.hostname = String(object.hostname)
      if (object.gametype != null) message.gametype = String(object.gametype)
      ...
      if (object.burstPower != null) message.burstPower = object.burstPower | 0
    ...
    ServerData.toObject = function toObject(message, options) {
      ...
      if (options.objects || options.defaults) object.vars = {}
      if (options.defaults) {
      ...
      if (message.players && message.players.length) {
        ...
        for (var j = 0; j < message.players.length; ++j)
          object.players[j] = $root.master.Player.toObject(
            message.players[j],
            options,
          )
      }
  ...
  master.Server = (function () {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            ...
            break
          case 2:
            message.Data = $root.master.ServerData.decode(
              reader,
              reader.uint32(),
            )
            break
    ...
    Server.fromObject = function fromObject(object) {
      if (object instanceof $root.master.Server) return object
      var message = new $root.master.Server()
      if (object.EndPoint != null) message.EndPoint = String(object.EndPoint)
      if (object.Data != null) {
  ...
  master.Servers = (function () {
        ...
        switch (tag >>> 3) {
          case 1:
            if (!(message.servers && message.servers.length))
              message.servers = []
            message.servers.push(
              $root.master.Server.decode(reader, reader.uint32()),
            )
            break
          default:
            reader.skipType(tag & 7)
    ...
    Servers.verify = function verify(message) {
      ...
      if (message.servers != null && message.hasOwnProperty('servers')) {
        if (!Array.isArray(message.servers)) return 'servers: array expected'
        for (var i = 0; i < message.servers.length; ++i) {
    ...
    Servers.fromObject = function fromObject(object) {
      if (object instanceof $root.master.Servers) return object
      var message = new $root.master.Servers()
      if (object.servers) {
    ...
    Servers.toObject = function toObject(message, options) {
      if (!options) options = {}
      var object = {}
      if (options.arrays || options.defaults) object.servers = []
      if (message.servers && message.servers.length) {
        object.servers = []
        for (var j = 0; j < message.servers.length; ++j)
          object.servers[j] = $root.master.Server.toObject(
            message.servers[j],
            options,
          )
      }
  ...
  master.ServerIcon = (function () {
    ...
    ServerIcon.verify = function verify(message) {
      ...
      if (message.icon != null && message.hasOwnProperty('icon'))
        if (
          !(
            (message.icon && typeof message.icon.length === 'number') ||
            $util.isString(message.icon)
          )
        )
    ...
    ServerIcon.fromObject = function fromObject(object) {
      if (object instanceof $root.master.ServerIcon) return object
      var message = new $root.master.ServerIcon()
      if (object.endPoint != null) message.endPoint = String(object.endPoint)
      if (object.icon != null)
        if (typeof object.icon === 'string')
          $util.base64.decode(
            object.icon,
            (message.icon = $util.newBuffer($util.base64.length(object.icon))),
            0,
          )
        else if (object.icon.length) message.icon = object.icon
      if (object.iconVersion != null)
        message.iconVersion = object.iconVersion | 0
      return message
    }
    ...
    ServerIcon.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        object.endPoint = ''
        if (options.bytes === String) object.icon = ''
        else {
          object.icon = []
      ...
      if (message.icon != null && message.hasOwnProperty('icon'))
        object.icon =
          options.bytes === String
            ? $util.base64.encode(message.icon, 0, message.icon.length)
            : options.bytes === Array
            ? Array.prototype.slice.call(message.icon)
            : message.icon
      if (message.iconVersion != null && message.hasOwnProperty('iconVersion'))
        object.iconVersion = message.iconVersion
      return object
  ...
  master.ServerIcons = (function () {
    ...
    ServerIcons.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1:
            if (!(message.icons && message.icons.length)) message.icons = []
            message.icons.push(
              $root.master.ServerIcon.decode(reader, reader.uint32()),
            )
            break
          default:
            reader.skipType(tag & 7)
    ...
    ServerIcons.verify = function verify(message) {
      ...
      if (message.icons != null && message.hasOwnProperty('icons')) {
        if (!Array.isArray(message.icons)) return 'icons: array expected'
        for (var i = 0; i < message.icons.length; ++i) {
    ...
    ServerIcons.fromObject = function fromObject(object) {
      if (object instanceof $root.master.ServerIcons) return object
      var message = new $root.master.ServerIcons()
      if (object.icons) {
    ...
    ServerIcons.toObject = function toObject(message, options) {
      if (!options) options = {}
      var object = {}
      if (options.arrays || options.defaults) object.icons = []
      if (message.icons && message.icons.length) {
        object.icons = []
        for (var j = 0; j < message.icons.length; ++j)
          object.icons[j] = $root.master.ServerIcon.toObject(
            message.icons[j],
            options,
          )
      }
